...
svg.check <- function(data_path = NULL,              ## String: output path of qc procedure
  ...
  if(perm == FALSE){
    ...
    if(svg_method != "SPARKX"){
      ...
      warning("The permutation procedure might spent some time! We recommend use \"SPARKX\".")
    }
...
# ###################
# ### test code
# data_path <- "/net/mulan/disk2/yasheng/stwebProject/03_result/02_Visium/Parent_Visium_Human_BreastCancer"
# output_path <- "/net/mulan/disk2/yasheng/stwebProject/03_result/02_Visium/Parent_Visium_Human_BreastCancer"
