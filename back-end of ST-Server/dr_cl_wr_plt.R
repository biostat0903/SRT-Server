#! /usr/bin/env Rscript
# visualize UMAP and location plot after using dr_cl_wr analysis
# up-stream code: dr_cl_wr.R
...
# Function 1
dr_cl_wr_plt.plot <- function(data_path1,                          ## String: output path for dr_cl_wr procedure
                              data_path2,                          ## String: output path for qc procedure
                              out_path,                            ## String: output path for dr_cl_wr procedure
  ...
  save(loc_plt1, loc_plt2, ft_plt, bb_plt, 
       file = paste0(out_path, "/dr_cl_wr_result/plot.RData"))
...
# dr_cl_wr_plt.plot(data_path1 = output_path,
